...
import { cellsDeltaToDuration, humanizeHours, PLANNING_T0 } from "./gantt_utils";
...
import { GanttAxisMixin } from "./gantt_renderer_axis";
import { GanttGesturesMixin } from "./gantt_renderer_gestures";
import {
    planHoursPerCell, planCellRange, planCellLabel, planDayLabel,
...
export class GanttRenderer extends Component {
    ...
    setup() {
        ...
        // Pointer gestures (drag, resize, marquee, …) — see
        // gantt_renderer_gestures.js. Called here because the hooks it
        // installs register OWL lifecycle callbacks, which only setup() may do.
        this._setupGestures();
...
// The axis (instant ↔ pixel) lives in gantt_renderer_axis.js. defineProperties
// with the descriptors, NOT Object.assign: assign would copy the GETTERS' current
// values instead of the getters themselves, so _useWorkTimeAxis and friends would
// freeze at whatever they evaluated to at load time.
for (const mixin of [GanttAxisMixin, GanttGesturesMixin]) {
    Object.defineProperties(
        GanttRenderer.prototype, Object.getOwnPropertyDescriptors(mixin));
}
